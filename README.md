...
Este proyecto es una aplicación **Spring Boot** desarrollada como parte del curso **ARSW (Arquitecturas de Software)**.  
...
└── blueprints
├── controllers
│ ├── BlueprintAPIController # Controlador REST principal
│ └── ResourceNotFoundException # Excepción para recursos no encontrados
│
├── filters
│ ├── impl
│ │ ├── RedundancyFilter # Filtro que elimina puntos redundantes
│ │ └── SubsamplingFilter # Filtro que submuestrea los puntos
│ └── BlueprintFilter # Interfaz genérica para filtros
│
├── model
│ ├── Blueprint # Entidad principal Blueprint
│ └── Point # Entidad que representa un punto (x, y)
│
├── persistence
│ ├── impl
│ │ ├── InMemoryBlueprintPersistence # Persistencia en memoria
│ │ └── Tuple # Clase de apoyo
│ ├── BlueprintNotFoundException # Excepción para Blueprint no encontrado
│ ├── BlueprintPersistenceException # Excepción genérica de persistencia
│ └── BlueprintsPersistence # Interfaz de persistencia
│
├── services
│ ├── impl
│ │ └── BlueprintServicesImpl # Implementación del servicio
│ └── BlueprintServices # Interfaz de servicios
│
└── blueprintapi
